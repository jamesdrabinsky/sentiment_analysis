...
I also scraped 5732 (after eliminating duplicates) using the Twython, a Python wrapper for the Twitter API.  That code can be found in this notebook <a href="code/06_tweet_scraper.ipynb">Tweet Scraper</a>
